...
const Inventory = () => {
  ...
  const [form, setForm] = useState({ name: "", category: "", quantity: "", minQuantity: "", price: "", supplier: "" });
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      setForm({ name: "", category: "", quantity: "", minQuantity: "", price: "", supplier: "" });
      setDialogOpen(false);
      fetchProducts();
    } catch (error: any) {
      toast({
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-right p-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Preço</th>
